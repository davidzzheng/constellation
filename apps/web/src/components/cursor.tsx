    ...
    <AnimatePresence>
      {isActive && (
        <motion.div
          ref={cursorRef}
          data-slot="cursor"
          className={cn("transform-[translate(-50%,-50%)] pointer-events-none absolute z-[9999]", className)}
    ...
    <AnimatePresence>
      {isActive && (
        <motion.div
          ...
          className={cn("transform-[translate(-50%,-50%)] pointer-events-none absolute z-[9998]", className)}
