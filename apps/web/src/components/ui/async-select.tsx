...
export function AsyncSelect<T>({
  ...
  return (
    <span style={{ "--select-width": width }} ref={containerRef}>
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            aria-expanded={open}
            className={cn(
              "w-(--select-width) justify-between",
        ...
        <PopoverContent className={cn("w-(--select-width) p-0", className)} container={containerRef.current}>
